...
function ListeReservation() {
  ...
  const [reservationPerPage] = useState(3);
        ...
        {currentReservation.map((reservation, index) => {
          ...
          return (
            <div key={index} className="reclamation-item">
              <p className={`reclamation-title ${reservation.showDetails ? 'clicked' : ''}`}
                onClick={() => handleToggleDetails(index + indexOfFirstReservation)}>
